    ...
    if (options.vinConfirm) {
      ...
      if (chassisShapedInput(text)) {
        return baseResult("needs_clarification", {
          ...
          kind: "chassis_hint",
          question: "That looks like it could be a chassis number from an older car. Cars before 1981 don't use standard VINs, so tell me the year, make and model and I'll take it from there.",
          chips: ["Not sure"]
        }, []);
      }
