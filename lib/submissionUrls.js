...
import { HOUSE_CONSIGN } from "./_houseComps.js";
export const SUBMISSION_URLS = {
  ...
  // The six auction-house CONSIGNMENT doors (Sep 2026): /out 302s here with the same click log
  // as an online submission. Source of truth is _houseComps.HOUSE_CONSIGN (verb "consign").
  ...Object.fromEntries(Object.entries(HOUSE_CONSIGN).map(([slug, h]) => [slug, h.url]))
};
