...
const NICKNAMES = [
  ...
  nick("Lambo", ["lambo"], [m("Lamborghini", null, null, null, null, { makeOnly: true })], "Lamborghini nickname (make-level)", "approved", "make-only; needs a model"),
...
const WINDOWS_DICT = [
  ...
  win("last 3 years", ["past 3 years", "last three years", "3 years", "trailing 3 years"], "36mo", "spec: last 3 years = 36 months"),
  win("last 24 months", ["past 24 months", "two years", "last 2 years"], "24mo", "24 months"),
...
const CHANNELS = [
  ...
  chan("the houses", ["at the houses", "at auction houses", "auction houses", "at the houses"], "house", "channel filter house"),
...
export const GROUPINGS = [
  {
    ...
    definedBy: "GoAskSam (CC draft, Sep 2026); mirrors spec s9 example",
    source: "spec s9: Supra, RX-7, NSX, 300ZX, 3000GT, MR2, Miata, S2000 (1999+), Skyline (where imported), Integra Type R",
    members: [
      ...
      m("Mitsubishi", "3000GT", 1990, 1999, null),
      m("Toyota", "MR2", 1990, 1999, null),
      m("Mazda", "MX-5", 1990, 1997, "NA"),
      m("Mazda", "MX-5", 1999, 1999, "NB"),
      m("Honda", "S2000", 1999, 1999, "AP1"),
      m("Nissan", "Skyline", 1990, 1999, null),
      m("Acura", "Integra Type R", 1997, 1999, null)
    ],
    note: "S2000 only its 1999 debut year falls in the 90s; Skyline where imported; NSX filed under Acura (US) and Honda (JDM)"
  },
  {
    ...
    category: "grouping", type: "grouping", status: "pending",
    definedBy: "GoAskSam (CC draft); Porsche air-cooled 911 = 901 through 993 (pre-1999)",
    source: "spec s1/s9/s11 Q3: 911 to 1998, the last air-cooled generation is 993",
    members: [
      m("Porsche", "911", 1964, 1973, "901"),
      m("Porsche", "911", 1974, 1988, "930"),
      m("Porsche", "911", 1990, 1994, "964"),
      m("Porsche", "911", 1994, 1998, "993")
    ],
    note: "excludes 996+ (water-cooled); the 1989 3.2 Carrera is deliberately unmapped in generations.js and folds into 911 by year"
  },
  {
    name: "muscle cars",
    phrase: "muscle cars",
    ...
    category: "grouping", type: "grouping", status: "pending",
    definedBy: "GoAskSam (CC draft); classic-era US intermediate/pony V8s, 1964-1972 core",
    source: "spec s4/s9: a NAMED list, never 'every V8 in the archive'",
    members: [
      m("Chevrolet", "Chevelle", 1964, 1972, null),
      m("Chevrolet", "Camaro", 1967, 1969, "first"),
      m("Pontiac", "GTO", 1964, 1972, null),
      m("Pontiac", "Firebird", 1967, 1972, null),
      m("Dodge", "Charger", 1966, 1974, null),
      m("Dodge", "Challenger", 1970, 1974, "first"),
      m("Plymouth", "Barracuda", 1970, 1974, null),
      m("Plymouth", "Road Runner", 1968, 1975, null),
      m("Ford", "Mustang", 1967, 1970, "first"),
      m("Ford", "Torino", 1968, 1971, null),
      m("Buick", "GS", 1965, 1972, null),
      m("Oldsmobile", "442", 1964, 1972, null)
    ],
    note: "Camaro/Firebird overlap the pony-car list by design; 'muscle' is the big-block intermediate reading"
  },
  {
    name: "pony cars",
    phrase: "pony cars",
    ...
    category: "grouping", type: "grouping", status: "pending",
    definedBy: "GoAskSam (CC draft); compact sporty coupes launched by the Mustang",
    source: "spec s4: named list",
    members: [
      m("Ford", "Mustang", 1965, 1973, "first"),
      m("Chevrolet", "Camaro", 1967, 1969, "first"),
      m("Pontiac", "Firebird", 1967, 1969, null),
      m("Plymouth", "Barracuda", 1964, 1969, null),
      m("Mercury", "Cougar", 1967, 1970, null),
      m("Dodge", "Challenger", 1970, 1974, "first"),
      m("AMC", "Javelin", 1968, 1974, null)
    ],
    note: "first-generation pony era; distinct from full muscle (intermediates)"
  },
  {
    name: "hot hatches",
    phrase: "hot hatches",
    variants: ["hot hatch", "hot-hatch", "hatch"],
    category: "grouping", type: "grouping", status: "pending",
    definedBy: "GoAskSam (CC draft); performance front-drive hatchbacks",
    source: "spec s4: named list",
    members: [
      m("Volkswagen", "Golf GTI", 1983, 2026, null),
      m("Volkswagen", "Golf R", 2012, 2026, null),
      m("Honda", "Civic Type R", 1997, 2026, null),
      m("Ford", "Focus RS", 2009, 2018, null),
      m("Ford", "Focus ST", 2013, 2018, null),
      m("Renault", "Clio", 2001, 2016, null),
      m("Mini", "Cooper S", 2002, 2026, null),
      m("Subaru", "WRX", 2002, 2026, null),
      m("Toyota", "GR Corolla", 2023, 2026, null)
    ],
    note: "WRX is a sedan in some years; kept as a canonical hot-hatch nameplate but flag if body-scoping is added"
  },
  {
    ...
    category: "grouping", type: "grouping", status: "pending",
    definedBy: "GoAskSam (CC draft); pre-traction-control, gated-manual supercars ~1984-2005",
    source: "spec s4/s9: named list; the 'analog' reading is an opinion, shown in full",
    members: [
    ...
    note: "boundary is an opinion (traction control / paddle shift end the era); the Carrera GT is the late bookend"
  },
  {
    ...
    category: "grouping", type: "grouping", status: "pending",
    definedBy: "GoAskSam (CC draft); classic UK open two-seaters",
    source: "spec s4: named list",
    members: [
    ...
    note: "E-Type roadster overlaps Italian-exotic-adjacent value; kept British by origin"
  },
  {
    ...
    category: "grouping", type: "grouping", status: "pending",
    definedBy: "GoAskSam (CC draft); Ferrari/Lamborghini/Maserati/Pagani halo cars",
    source: "spec s4: named list; broad by design, shown in full so the user can prune",
    members: [
      m("Ferrari", "F40", 1987, 1992, null),
      m("Ferrari", "Testarossa", 1984, 1991, null),
      m("Ferrari", "308 GTB", 1975, 1985, null),
      m("Lamborghini", "Countach", 1974, 1990, null),
      m("Lamborghini", "Miura", 1966, 1973, null),
      m("Lamborghini", "Diablo", 1990, 2001, null),
      m("Maserati", "Ghibli", 1967, 1973, null),
      m("De Tomaso", "Pantera", 1971, 1992, null),
      m("Pagani", "Zonda", 1999, 2017, null)
    ],
    note: "Pantera is US-engined but Italian-bodied; kept, flagged in the note"
  },
  {
    name: "overlanders",
    phrase: "overlanders",
  ...
  },
  {
    ...
    category: "grouping", type: "grouping", status: "pending",
    definedBy: "GoAskSam (CC draft); emblematic US 1973-1983 emissions-choked cars (also an era span)",
    source: "spec s4/s6: named list; the era ENTRY carries the 1973-1983 year span, this grouping names emblematic models",
    members: [
      m("Chevrolet", "Corvette", 1975, 1982, "C3"),
      m("Pontiac", "Firebird", 1973, 1981, null, { trim: "Trans Am" }),
      m("Ford", "Mustang", 1974, 1978, "second"),
    ...
    note: "the era ENTRY (1973-1983) is the span; this grouping is the emblematic-model reading for 'best malaise era cars'"
  }
];
