...
export async function executeDsl(dsl, env, opts = {}) {
  ...
  if (isRecord) {
    ...
    record = {
      definition: `Record means the single highest STANDARD sale in our data over ${win.label}${covStart ? ` (earliest in this pool ${covStart})` : ""}. Halos, race cars, restomods and period tuner cars are set aside unless the question asks for them.`,
