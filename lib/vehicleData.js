...
export const MAKE_ALIASES = [
  ...
  // Concatenated (no-space) forms of multi-word makes are formatting VARIANTS, not
  // misspellings: expand silently (rule 6) rather than asking "Did you mean". Without
  // these the edit-distance path treats the missing space as a typo and confirms.
  { alias: "landrover", make: "Land Rover", kind: "abbreviation" },
  { alias: "mercedesbenz", make: "Mercedes-Benz", kind: "abbreviation" },
  { alias: "astonmartin", make: "Aston Martin", kind: "abbreviation" },
  { alias: "alfaromeo", make: "Alfa Romeo", kind: "abbreviation" },
  { alias: "rollsroyce", make: "Rolls-Royce", kind: "abbreviation" },
  { alias: "austinhealey", make: "Austin-Healey", kind: "abbreviation" },
...
export const TRIM_VOCABULARY = new Set([
  ...
  "stingray","grand","shelby","boss","mach","cobra","raptor","lightning","king","ranch","xlt","xl","lariat","tremor",
