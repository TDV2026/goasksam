...
export const MODEL_ALIASES = [
  ...
  ...[
    ["230sl", "230SL"], ["250sl", "250SL"], ["280sl", "280SL"], ["350sl", "350SL"],
    ["380sl", "380SL"], ["420sl", "420SL"], ["450sl", "450SL"], ["500sl", "500SL"]
  ].flatMap(([a, badge]) => [
    { alias: a, make: "Mercedes-Benz", model: "SL-Class", trim: badge, kind: "nickname" },
    { alias: a.replace("sl", " sl"), make: "Mercedes-Benz", model: "SL-Class", trim: badge, kind: "nickname" }
  ]),
  ...[
    ["190e", "190E"], ["300e", "300E"], ["400e", "400E"], ["500e", "500E"],
    ["e320", "E320"], ["e430", "E430"], ["e500", "E500"], ["e550", "E550"]
  ].flatMap(([a, badge]) => [
