...
export const MODEL_ALIASES = [
  ...
  // The CLK DTM AMG is a rare (~100 coupes/80 cabrios) house-sold car titled "CLK DTM AMG",
  // NOT a mainstream CLK: the longest-alias rule makes "clk dtm" win over "clk", resolving to a
  // bare CLK + DTM trim so the fetch keyword is "CLK DTM" (29 real sold records) rather than the
  // "-Class" family defrag (which would miss it). DTM is added to TRIM_VOCABULARY below.
  { alias: "clk dtm", make: "Mercedes-Benz", model: "CLK", trim: "DTM", kind: "nickname" },
