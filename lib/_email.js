...
// Resend requires a verified sender domain. Override with LEAD_EMAIL_FROM once the
// goasksam.com domain is verified in Resend; the default is the expected address.
const DEFAULT_FROM = "GoAskSam Leads <leads@goasksam.com>";
