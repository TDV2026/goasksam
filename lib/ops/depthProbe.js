...
export const INTEGRATED = {
  ...
  rmsothebys: "RM Sotheby's", sothebysmotorsport: "Sotheby's Motorsport",
  hemmings: "Hemmings"
  // autohunter removed Aug 2026: out of business, no longer fetched/probed.
};
...
// The US-launch default set for the web trigger: the launch platforms, ordered
// launch-priority FIRST. A bounded probe (a request ceiling) validates the
// never-fetched candidate (MB Market) and the sparser platforms before the dense
// giants (Cars & Bids, Bring a Trailer) would consume the whole budget.
// AutoHunter removed Aug 2026 (defunct): never probed/fetched again.
export const LAUNCH_SOURCES = [
  "mbmarket", "sothebysmotorsport", "hemmings",
