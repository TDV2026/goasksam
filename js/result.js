async function showSellRecommendation(opts){
  ...
  if(decisionData&&/^(account_required|limit_reached|daily_limit_reached|tester_daily_limit_reached|ip_rate_limited|auth_required|capacity)$/.test(decisionData.status||"")){
