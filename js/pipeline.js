...
const STEP_SPECS={
  ...
  11:{field:"region",required:true,valid:v=>/\b(us|usa|united|america|american|states|uk|britain|kingdom|england|scotland|wales|europe|european|australia|middle east|uae|dubai|canada|canadian|elsewhere|other)\b/i.test(v)||!!normalizeUSState(v)},
