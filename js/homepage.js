...
function showHowItWorks() {
  ...
  msgs.innerHTML = `<div class="hp-decides">
    ...
    <section class="hd-sec">
      ...
      <p>Real data costs real money. Every search pulls real market records, and running that properly is expensive, so for now we cap searches rather than cut corners on the data. Daily Vroom readers get 15 searches a month; everyone else gets 5. Before we open this up wider, we wanted to share it with the TDV community first. More ways to earn extra searches, starting with referring friends, are coming. Signing in is what keeps your results, applies your allowance, and helps us trace bugs when you report them.</p>
    </section>
    <section class="hd-sec">
